...
class CommonSettings(Configuration):
    ...
    ROOT_URLCONF = 'coursera_fetch.urls'
    TEMPLATES = [
        {
    ...
    WSGI_APPLICATION = 'coursera_fetch.wsgi.application'
    ...
    GRAPHENE = {
        'SCHEMA': 'coursera_fetch.schema.schema'
    }
    TEST_RUNNER = 'coursera_fetch.runner.PytestTestRunner'
    DEBUG = True
