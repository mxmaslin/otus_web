...
class CommonSettings(Configuration):
    ...
    ROOT_URLCONF = 'coursera_optimized.urls'
    TEMPLATES = [
        {
    ...
    WSGI_APPLICATION = 'coursera_optimized.wsgi.application'
    ...
    GRAPHENE = {
        'SCHEMA': 'coursera_optimized.schema.schema'
    }
    TEST_RUNNER = 'coursera_optimized.runner.PytestTestRunner'
